...
Section.belongsTo(ClassLevel, {
  foreignKey: "class_level_id",
  as: "classLevel",
});

ClassLevel.hasMany(Subject, { foreignKey: "class_level_id", as: "subjects" });
Subject.belongsTo(ClassLevel, {
  foreignKey: "class_level_id",
  as: "classLevel",
});
...
Inquiry.belongsTo(ClassLevel, {
  foreignKey: "class_applying_id",
  as: "classApplying",
});
...
Inquiry.belongsToMany(InquiryTag, {
  through: InquiryTagMap,
  foreignKey: "inquiry_id",
  as: "tags",
});
InquiryTag.belongsToMany(Inquiry, {
  through: InquiryTagMap,
  foreignKey: "tag_id",
  as: "inquiries",
});
